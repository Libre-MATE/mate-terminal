...
#define TERMINAL_CONFIG_COMPAT_VERSION \
  (1) /* Bump this for incompatible changes */
...
#define TERMINAL_APP(object) \
  (G_TYPE_CHECK_INSTANCE_CAST((object), TERMINAL_TYPE_APP, TerminalApp))
#define TERMINAL_APP_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), TERMINAL_TYPE_APP, TerminalAppClass))
#define TERMINAL_IS_APP(object) \
  (G_TYPE_CHECK_INSTANCE_TYPE((object), TERMINAL_TYPE_APP))
#define TERMINAL_IS_APP_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), TERMINAL_TYPE_APP))
#define TERMINAL_APP_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), TERMINAL_TYPE_APP, TerminalAppClass))
...
void terminal_app_edit_keybindings(TerminalApp *app,
                                   GtkWindow *transient_parent);
void terminal_app_edit_encodings(TerminalApp *app, GtkWindow *transient_parent);

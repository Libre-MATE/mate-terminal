...
#define TERMINAL_TABS_MENU(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), TERMINAL_TYPE_TABS_MENU, TerminalTabsMenu))
#define TERMINAL_TABS_MENU_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), TERMINAL_TYPE_TABS_MENU, TerminalTabsMenuClass))
#define TERMINAL_IS_TABS_MENU(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), TERMINAL_TYPE_TABS_MENU))
#define TERMINAL_IS_TABS_MENU_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), TERMINAL_TYPE_TABS_MENU))
#define TERMINAL_TABS_MENU_GET_CLASS(o)                    \
  (G_TYPE_INSTANCE_GET_CLASS((o), TERMINAL_TYPE_TABS_MENU, \

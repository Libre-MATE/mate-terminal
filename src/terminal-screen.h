...
#define TERMINAL_SCREEN(object) \
  (G_TYPE_CHECK_INSTANCE_CAST((object), TERMINAL_TYPE_SCREEN, TerminalScreen))
#define TERMINAL_SCREEN_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), TERMINAL_TYPE_SCREEN, TerminalScreenClass))
#define TERMINAL_IS_SCREEN(object) \
  (G_TYPE_CHECK_INSTANCE_TYPE((object), TERMINAL_TYPE_SCREEN))
#define TERMINAL_IS_SCREEN_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), TERMINAL_TYPE_SCREEN))
#define TERMINAL_SCREEN_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), TERMINAL_TYPE_SCREEN, TerminalScreenClass))
...
struct _TerminalScreenClass {
  ...
  void (*profile_set)(TerminalScreen *screen, TerminalProfile *old_profile);
  void (*show_popup_menu)(TerminalScreen *screen,
                          TerminalScreenPopupInfo *info);
  gboolean (*match_clicked)(TerminalScreen *screen, const char *url,
                            int flavour, guint state);
...
void terminal_screen_get_size(TerminalScreen *screen, int *width_chars,
                              int *height_chars);
void terminal_screen_get_cell_size(TerminalScreen *screen, int *width_chars,
                                   int *height_chars);

...
#define TERMINAL_INFO_BAR(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), TERMINAL_TYPE_INFO_BAR, TerminalInfoBar))
#define TERMINAL_INFO_BAR_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), TERMINAL_TYPE_INFO_BAR, TerminalInfoBarClass))
#define TERMINAL_IS_INFO_BAR(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), TERMINAL_TYPE_INFO_BAR))
#define TERMINAL_IS_INFO_BAR_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), TERMINAL_TYPE_INFO_BAR))
#define TERMINAL_INFO_BAR_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), TERMINAL_TYPE_INFO_BAR, TerminalInfoBarClass))

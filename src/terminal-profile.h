...
typedef enum {
  /* this has to be kept in sync with the option menu in the profile editor UI
     file */
...
#define TERMINAL_PROFILE(object) \
  (G_TYPE_CHECK_INSTANCE_CAST((object), TERMINAL_TYPE_PROFILE, TerminalProfile))
#define TERMINAL_PROFILE_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), TERMINAL_TYPE_PROFILE, \
                           TerminalProfileClass))
#define TERMINAL_IS_PROFILE(object) \
  (G_TYPE_CHECK_INSTANCE_TYPE((object), TERMINAL_TYPE_PROFILE))
#define TERMINAL_IS_PROFILE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), TERMINAL_TYPE_PROFILE))
#define TERMINAL_PROFILE_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), TERMINAL_TYPE_PROFILE, \
                             TerminalProfileClass))

...
#define TERMINAL_OPTION_ERROR \
  (g_quark_from_static_string("terminal-option-error"))
...
TerminalOptions *terminal_options_parse(
    const char *working_directory, const char *display_name,
    const char *startup_id, char **env, gboolean remote_arguments,
    gboolean ignore_unknown_options, int *argcp, char ***argvp, GError **error,
